...
#define MEM_PAGE_SIZE			(1 << MEM_L1FIELD_FIRST_BITNUM)
#define MEM_FREEMAP_SIZE		(MEM_MAX_SIZE / MEM_PAGE_SIZE / 32)
#define MEM_L1TABLE_SIZE		(MEM_MAX_VIRTUAL_ADDRESSS + 5) / MEM_PAGE_SIZE
#define MEM_ADDRESS_OFFSET_MASK		MEM_PAGE_SIZE - 1
#define MEM_PTE_MASK			0xffffffff << MEM_L1Field_FIRST_BITNUM
